...
(function()
 {
    ...
    {
        debugLog("Initializing PhoneGap()"); //@ibm
        var state = document.readyState;
...
Camera.prototype.win = function(picture)
{
    try {
        ...
        console.log("ERROR in camera success callback: "+e);
    }
}
...
Camera.prototype.fail = function(err)
{
    try {
        ...
        console.log("ERROR in camera error callback: "+e);
    }
}
...
Device.prototype.setBackButtonBehavior = function(b) {
    window.PhoneGap.setBackButtonBehavior(b);
};

Device.prototype.getBackButtonBehavior = function() {
    return window.PhoneGap.getBackButtonBehavior();
};
...
//@ibm PhoneGap.addConstructor(function() { if (typeof navigator.fileMgr == "undefined") navigator.fileMgr = new FileMgr();});
...
function FileMgr()
{
    ...
    this.getFileBasePaths();
        ...
        debugLog("ERROR in FileMgr: "+e);   //@ibm
    }                                       //@ibm
}
...
PhoneGap.addConstructor(function() { if (typeof navigator.fileMgr == "undefined") navigator.fileMgr = new FileMgr();}); //@ibm
...
Geolocation.prototype.gotCurrentPosition = function(lat, lng, alt, altacc, head, vel, stamp)
{
  ...
  {
    if (lat == 0) {             //@ibm 11501 Burnet Rd, Austin, TX
        lat = 30.4018620;       //@ibm
        lng = -97.7157070;      //@ibm
    }                           //@ibm
 ...
 */
// @BC NOT NEEDED FOR ANDROID 2.0 - MUST COMMENT OUT OR GET ERROR.
/*
...
debugLog("phonegap.js loaded"); //@ibm
